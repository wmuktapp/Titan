...
def main(config_file):
    ...
    try:
        ...
        if extract_destination is not None:
            extract_options = extract.get("options", [])
            extract_key = models.start_extract_log(execution_key, extract_options)["AcquireKey"]
            _execute_program(extract_destination, extract_options, models.end_extract_log, extract_key,
